...
{pkgs}: {
  ...
  input = ''
    ...
    // https://yalert.github.io/niri/Configuration:-Input
    input {
  ...
  outputs = ''
    ...
    // https://yalert.github.io/niri/Configuration:-Outputs
  ...
  # Layout configuration (gaps, window sizing, focus ring, border, etc.)
  layout = ''
    // Settings that influence how windows are positioned and sized.
    // Find more information on the wiki:
    // https://yalert.github.io/niri/Configuration:-Layout
    layout {
  ...
  animations = ''
    ...
    // https://yalert.github.io/niri/Configuration:-Animations
    animations {
  ...
  windowRules = ''
    ...
    // Find more information on the wiki:
    // https://yalert.github.io/niri/Configuration:-Window-Rules
  ...
  # Universal keybindings (non-keyboard-profile-specific)
  # These are the same for all keyboard profiles
  # Note: This is the CONTENT of the binds block, not including the binds { } wrapper
  universalBindings = ''
  ...
  # Placeholder for profile-specific function key bindings (will be injected)
  # Format is the content of the binds section with function key bindings
  profileBindings = "// Profile-specific function key bindings will be injected here";
}
