...
in {
  ...
  config = {
    ...
    # Create webex-tui config using systemd service that copies secrets without modification
    systemd.services.webex-tui-config = mkIf cfg.enable {
      description = "Setup webex-tui client config";
